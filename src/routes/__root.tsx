...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kit Consultório Lúdico" },
      { property: "og:description", content: "+80 recursos terapêuticos prontos para imprimir e usar em qualquer sessão infantil." },
